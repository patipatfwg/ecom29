...
class Curl
{
    ...
    public function putJson($url, $data=array())
    {
        $this->setopt(CURLOPT_URL, $url);
        //$this->setopt(CURLOPT_URL, $url);
    ...
    public function deleteWithHeader($url, $data=array())
    {
        $this->setopt(CURLOPT_URL, $url);
        $this->setopt(CURLOPT_POST, TRUE);
        ...
        $this->setopt(CURLOPT_POSTFIELDS, http_build_query($data));
        $this->setopt(CURLOPT_RETURNTRANSFER, true);
        $this->setopt(CURLOPT_HTTPHEADER, ['Content-Type: application/x-www-form-urlencoded']);
        $this->_exec();
    }

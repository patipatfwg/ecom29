...
class CategoryUpdateRequest extends Request
{
	...
	public function messages()
	{
		return [
			...
			'image_position_A.mimes'         => 'Banner main category (A) image type must be .jpg, .jpeg, .png format',
			...
			'image_position_B.mimes'         => 'Banner main category (B) image type must be .jpg, .jpeg, .png format',
			...
			'image_position_C.mimes'         => 'Banner main category (C) image type must be .jpg, .jpeg, .png format',
			...
			'image_position_D1_1.mimes'      => 'Banner main category (D1_1) image type must be .jpg, .jpeg, .png format',
			...
			'image_position_D1_2.mimes'      => 'Banner main category (D1_2) image type must be .jpg, .jpeg, .png format',
			...
			'image_position_D1_3.mimes'      => 'Banner main category (D1_3) image type must be .jpg, .jpeg, .png format',
			...
			'image_position_D2.mimes'        => 'Banner main category (D2) image type must be .jpg, .jpeg, .png format',
			...
			'image_position_D3.mimes'        => 'Banner main category (D3) image type must be .jpg, .jpeg, .png format',
			...
			'image_position_D4.mimes'        => 'Banner main category (D4) image type must be .jpg, .jpeg, .png format',
			...
			'image_position_D5.mimes'        => 'Banner main category (D5) image type must be .jpg, .jpeg, .png format',
			...
			'image_position_D6.mimes'        => 'Banner main category (D6) image type must be .jpg, .jpeg, .png format',

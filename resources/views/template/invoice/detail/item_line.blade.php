...
@else
    ...
    <div class="line font-read">
        <div class="detail-column-1 fl full-height border-right text-left nowrap black pd-l-1">
            เงื่อนไขส่วนลด
        </div>
        <div class="detail-column-2 fl full-height border-right text-center black"></div>
    ...
    <div class="line font-read">
        <div class="detail-column-1 fl full-height border-right text-center black"></div>
        <div class="detail-column-2 fl full-height border-right text-left black pd-l-1">
            รวมส่วนลด
        </div>
        <div class="detail-column-3 fl full-height border-right text-center black"></div>
        <div class="detail-column-4 fl full-height border-right text-center black"></div>
    ...
    <div class="line font-read">
        ...
        <div class="detail-column-2 fl full-height border-right text-left nowrap black pd-l-1">
    ...
    <div class="line font-read">
        ...
        <div class="detail-column-3 fl full-height border-right text-left black pd-l-1">
    ...
    <div class="line font-read">
        ...
        <div class="detail-column-5 fl full-height border-right text-center">รวม</div>
    ...
    <div class="line font-read">
        ...
        <div class="detail-column-3 fl full-height border-right">
            ...
            <div class="half-width fl nopadding text-right black pd-r-1">
                {{ isset($data['unit_price'])? $data['unit_price'] : ''}}
            </div>
        </div>
        <div class="detail-column-4 fl full-height border-right text-right black pd-r-1">
            {{ isset($data['vat_amount'])? $data['vat_amount'] : ''}}
        </div>
        <div class="detail-column-5 fl full-height border-right text-right black pd-r-1">
            {{ isset($data['total_amount'])? $data['total_amount'] : ''}}
        </div>
        <div class="detail-column-6 fl full-height border-right text-right black"></div>
        <div class="detail-column-7 fl full-height border-right text-center black"></div>
    ...
    <div class="line font-read">
        ...
        <div class="detail-column-6 fl full-height border-right text-right black"></div>
        <div class="detail-column-7 fl full-height border-right text-center black"></div>
        <div class="detail-column-8 fl full-height text-right black pd-r-1"></div>
    </div>
    @else
    <div class="line font-read">
        <div class="detail-column-1 fl full-height border-right text-center black"></div>

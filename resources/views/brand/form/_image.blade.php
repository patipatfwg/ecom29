        ...
        <div class="col-lg-8">
            ...
            <div class="fileupload fileupload-new input-group" data-provides="fileupload">
                ...
                <div class="form-inline">
                    <div class="fileupload fileupload-new input-group" data-provides="fileupload">
                        ...
                        <span class="input-group-btn input-group-btn-fileupload">
                            ...
                            <a href="#" class="btn btn-danger fileupload-new remove-exists" data-dismiss="fileupload" reference="{{ $type }}">Remove</a>
                            @endif
                        </span>
                    </div>
                </div>
                ...
                <div class="fileupload-new thumbnail">
                    ...
                    <input type="hidden" id="{{ $type . '_old' }}" name="{{ $input_name.'[old]' }}" value="{{isset($image)? $image : ''}}">

                    @if(isset($image) && !empty($image))
                        <img id="{{ $type . '_display' }}" class="thumb_old" src="{{ $image }}">
                    @else

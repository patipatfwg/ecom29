@if(!isset($data['type']))
{{--
<table width="100%" cellpadding="0" cellspacing="0" style="overflow: hidden; table-layout:fixed; autosize: 1;">
    <tbody>
    <tr style="width:100%;">
        <td class="detail-column-1 border-right" style="height:5mm;">111111111</td>
        <td class="detail-column-2 border-right" style="height:5mm;">2</td>
        <td class="detail-column-3 border-right" style="height:5mm;">3</td>
        <td class="detail-column-4 border-right" style="height:5mm;">4</td>
        <td class="detail-column-5 border-right" style="height:5mm;">5</td>
        <td class="detail-column-6 border-right" style="height:5mm;">6</td>
        <td class="detail-column-7 border-right" style="height:5mm;">7</td>
        <td class="detail-column-8" style="height:5mm;">8</td>
    </tr>
    </tbody>
</table>
--}}
...
@else
    ...
    <div class="line font-read">
        <div class="detail-column-1 fl full-height border-right text-left nowrap black">
            เงื่อนไขส่วนลด
        </div>
        <div class="detail-column-2 fl full-height border-right text-center black"></div>
    ...
    <div class="line font-read">
        ...
        <div class="detail-column-2 fl full-height border-right text-left nowrap black">

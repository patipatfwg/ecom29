...
<head>
    ...
    {{ Html::style('assets/css/css-loader.css') }}
    <!-- end: CSS -->
...
<body class="navbar-top">
    ...
    <script type="text/javascript">
        ...
        $(document).bind("ajaxStart",function(){
            NProgress.set(.4),NProgress.start()
        });
    ...
    <script type="text/javascript">
        ...
        swal({
            ...
            title: "Result",
            @endif
            @if(!empty(session()->get("alert.text")))
    ...
    <script type="text/javascript">
    var time = (({!! env('SESSION_LIFETIME') !!} * 60000 ) + 1000);
    setTimeout(function() {
        if(typeof($.cookie('laravel_session')) === 'undefined') {
            location.reload();
        }
    }, time);

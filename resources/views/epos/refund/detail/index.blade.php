...
@section('title', 'Refunds Detail')

@section('breadcrumb')
    <li><a href="/epos/refund">Refund List Search</a></li>
        ...
        <div class="panel-footer">
            <div class="col-lg-12">
                <div class="text-right">
                    ...
                    {{--{{ Form::button('<span class="icon-c-crown-plus"></span> Create User', 'admin.users.create', null, array('class'=>'btn btn-primary btn-lg btn-block')) }}--}}
                </div>
            </div>
        </div>
    </div>

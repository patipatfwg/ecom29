...
@section('content')
<form id="form-submit" method="post" action="/category/{{ $category_id }}" enctype="multipart/form-data" class="form-horizontal" autocomplete="off">
        ...
        <div class="panel-body">
            <div class="row">
                <div class="col-lg-12">
                                        ...
                                        <div class="col-lg-12">
                                            <div class="form-group">
                                                <label for="input[{{ $value }}][name_{{ $value }}]">
                                                    {{ trans_append_language('Product Category Name',$value) }}<span class="text-danger">*</span>
                                                </label>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <a target="_blank" href="/category/position/position-category{{ $category['level'] }}">Instruction/guideline for upload images</a>
                        </div>
                    </div>
...
@section('footer_script')
    ...
    var validateData = {
        ...
        validate: function () {
            ...
            $.ajax({
                type: 'POST',
                url: $("meta[name='root-url']").attr('content') + '/category/{{ $category_id }}',
                data: formData,
                dataType: 'json',
                cache: false,
                processData: false,

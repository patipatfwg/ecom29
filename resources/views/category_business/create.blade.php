...
@section('content')
    ...
    <form id="form-submit" action="/category_business/create" method="post" class="form-horizontal" autocomplete="off" enctype="multipart/form-data">
            ...
            <div class="panel-body">
                <div class="row">
                                            ...
                                            <div class="col-lg-12">
                                                <div class="form-group">
                                                    <label for="input[{{ $lang }}][name_{{ $lang }}]">
                                                        {{ trans_append_language('Business Category Name',$lang) }} <span class="text-danger">*</span>
                                                    </label>
                    ...
                    <br />
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <a target='_blank' href='/category_business/position/position-category{{ $level }}'>Instruction/guideline for upload images</a>
                            </div>
                        </div>
...
@section('footer_script')
    ...
    var validateData = {
        ...
        validate: function () {
            ...
            $.ajax({
                type: 'POST',
                url: $("meta[name='root-url']").attr('content') + '/category_business/create',
                data: formData,
                dataType: 'json',
                cache: false,
                processData: false,

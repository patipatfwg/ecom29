...
<div class="panel">
    <div class="panel-body table-responsive">
        <table class="table table-border-gray table-striped datatable-dom-position" id="category-business-table" data-page-length="10" width="100%">
            <thead>
                <tr>
                    ...
                    <th>Business Category Name (TH)</th>
                    <th>Business Category Name (EN)</th>
...
<script type="text/javascript">
    var url    = '/category_business';

    var $table = $('#category-business-table');
    ...
    var oTable = $table.on('error.dt', function(e, settings, techNote, message) {
        ...
        ajax: {
            url: $("meta[name='root-url']").attr('content') + '/category_business/data',
            type: 'POST',
            data: function (d) {
    ...
    $('div.datatable-header').append(`
        ...
        @include('common._create_button', ['url' => URL::to('category_business/create/'.$category_id)])
    `);
</script>
